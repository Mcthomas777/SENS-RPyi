...
def CAM_att(img):
    ...
    # Az, Alt dela cam
    x_cam, y_cam, z_cam = (r_IMU_cam*r_imu_g_q*r_cam_azalt).as_euler('zxy', degrees = True)
...
def Stats(m, path, date, time, a, nbr_pics) :
...
path = '/home/pi/Projet_Stage/Prototype_A/Result/' + dir_n
...
if a == 'y':
    ...
    date = datetime[0]
    time = datetime[1]
    Stats(Att_log, path, date, time, a, nbr_pics)
