...
mat_path = 'C:\Users\jthom\Desktop\SENS_RPyi\Calibration_IMU_CAM\Allan_Variance\VA_Matlab\imu_mtig700.mat';
...
ts_imuw = timeseries(data_imu(:,2:4),data_imu(:,1));
ts_imua = timeseries(data_imu(:,5:7),data_imu(:,1));
